...
export const DashboardTopbar = (): React.JSX.Element => {
  ...
  return (
    <header className="sticky top-0 z-30 rounded-2xl border border-zinc-200/70 bg-white/70 px-3 py-3 shadow-sm backdrop-blur sm:top-4 dark:border-white/10 dark:bg-zinc-950/40">
          ...
          <div className="flex shrink-0 flex-wrap items-center justify-end gap-1.5 sm:gap-2">
            {showInboxActions ? (
              <button
                ...
                className="inline-flex h-10 shrink-0 items-center justify-center rounded-xl bg-emerald-600 px-2.5 text-xs font-semibold text-white shadow-sm shadow-emerald-600/20 transition hover:bg-emerald-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 sm:px-4 sm:text-sm dark:bg-emerald-500 dark:text-zinc-950 dark:hover:bg-emerald-400"
              >
                New message
              </button>
            ) : null}
            ...
            <button
              type="button"
              className="flex max-w-[44vw] items-center gap-2 rounded-xl border border-zinc-200/70 bg-white/70 px-2 py-2 shadow-sm backdrop-blur transition hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 sm:gap-3 sm:px-3 dark:border-white/10 dark:bg-zinc-950/40 dark:hover:bg-zinc-950"
              aria-label="Open profile menu"
            >
              <span
                className="grid size-8 shrink-0 place-items-center rounded-lg bg-gradient-to-br from-emerald-500 to-sky-500 text-xs font-bold text-white"
                aria-hidden="true"
              >
                CF
              </span>
